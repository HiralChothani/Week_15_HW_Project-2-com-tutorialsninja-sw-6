...
public class LaptopsAndNotebooksPage extends Utility {
    ...
    public List<Double> beforeSortingPriceHighToLow() {
        log.info("Verify the Product price will arrange in High to Low order");
    ...
    public String verifyModifiedYourShoppingCart(){
        log.info("Verify modified your shopping cart");
    ...
    public void clickOnGuestCheckOutRadioButton(){
        log.info("click on guest checkout radiobutton");
    ...
    public void clickOnTermsAndConditionsCheckBox() {
        log.info("click on Terms & Conditions check box");
